...
export function useGetReviewsByProductHandle(vars: GetReviewsByProductHandleVariables, options?: useDataConnectQueryOptions<GetReviewsByProductHandleData>): UseDataConnectQueryResult<GetReviewsByProductHandleData, GetReviewsByProductHandleVariables>;
export function useGetReviewsByProductHandle(dc: DataConnect, vars: GetReviewsByProductHandleVariables, options?: useDataConnectQueryOptions<GetReviewsByProductHandleData>): UseDataConnectQueryResult<GetReviewsByProductHandleData, GetReviewsByProductHandleVariables>;
