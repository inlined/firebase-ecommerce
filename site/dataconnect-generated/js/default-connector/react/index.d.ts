...
export function useGetOrdersByCustomerId(options?: useDataConnectQueryOptions<GetOrdersByCustomerIdData>): UseDataConnectQueryResult<GetOrdersByCustomerIdData, undefined>;
export function useGetOrdersByCustomerId(dc: DataConnect, options?: useDataConnectQueryOptions<GetOrdersByCustomerIdData>): UseDataConnectQueryResult<GetOrdersByCustomerIdData, undefined>;
